...
// Example demontrating how to use TinyJambu-192 AEAD C++20 header-only
// library API.
//
// Compile with
//
// g++ -Wall -std=c++20 -O3 -I ./include example/tinyjambu_192.cpp
int
main()
{
  // 192 -bit secret key
  constexpr size_t k_len = 24ul;
  ...
  std::cout << "TinyJambu-192 AEAD" << std::endl << std::endl;
